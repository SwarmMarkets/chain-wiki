...
import { FontSizeProps, FontStyleProps, FontWeightProps, LineHeightProps, SpaceProps, TextAlignProps, fontSize, fontStyle, fontWeight, lineHeight, space, textAlign } from 'styled-system'
