    ...
    inputs: [
      {
        indexed: false,
        internalType: "uint256",
        name: "newMaxArraySize",
        type: "uint256",
      },
    ],
    name: "NewMaxArraySizeSet",
    type: "event",
  },
  {
    anonymous: false,
...
export class SX1155NFT__factory {
  static readonly abi = _abi;
  static createInterface(): SX1155NFTInterface {
    return new utils.Interface(_abi) as SX1155NFTInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SX1155NFT {
    return new Contract(address, _abi, signerOrProvider) as SX1155NFT;
  }
}
