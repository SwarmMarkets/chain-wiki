...
const { contractsAddresses: { sx1155NFTFactoryAddress }  } = environment

export const useSX1155NFTFactory = () => {
  const web3Contract = useWeb3Contract<SX1155NFTFactory>(sx1155NFTFactoryAddress, SX1155NFTFactoryABI)
  return web3Contract
}