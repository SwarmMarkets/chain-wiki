...
export type NfTsQuery = { __typename?: 'Query', nfts: Array<{ __typename?: 'NFT', id: string, name: string, symbol: string, createdAt: string, updatedAt: string, creator: string, uri: string, indexPagesUri: string, logoUrl: string, iconLogoUrl: string, admins: Array<string>, editors: Array<string>, preferredAttestators: Array<string> }> };
