...
export type NftQuery = { __typename?: 'Query', nft?: { __typename?: 'NFT', id: string, name: string, symbol: string, updatedAt: string, createdAt: string, uri: string, indexPagesUri: string, headerLinksUri: string, logoUrl: string, creator: string, admins: Array<string>, editors: Array<string>, headerBackground: string } | null };
...
export type NfTsQuery = { __typename?: 'Query', nfts: Array<{ __typename?: 'NFT', id: string, name: string, symbol: string, createdAt: string, updatedAt: string, creator: string, uri: string, indexPagesUri: string, logoUrl: string, admins: Array<string>, editors: Array<string> }> };
