...
export type CommentIdsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', id: string }> };
...
export type NftQuery = { __typename?: 'Query', nft?: { __typename?: 'NFT', id: string, name: string, symbol: string, updatedAt: string, createdAt: string, uri: string, indexPagesUri: string, headerLinksUri: string, logoUrl: string, iconLogoUrl: string, creator: string, admins: Array<string>, editors: Array<string>, headerBackground: string } | null };
...
export type NfTsQuery = { __typename?: 'Query', nfts: Array<{ __typename?: 'NFT', id: string, name: string, symbol: string, createdAt: string, updatedAt: string, creator: string, uri: string, indexPagesUri: string, logoUrl: string, iconLogoUrl: string, admins: Array<string>, editors: Array<string> }> };
...
export type TokenQuery = { __typename?: 'Query', token?: { __typename?: 'Token', createdAt: string, id: string, name: string, voteProposalUri: string, updatedAt: string, uri: string, nft: { __typename?: 'NFT', createdAt: string, creator: string, id: string, name: string, symbol: string, updatedAt: string, uri: string } } | null };
...
export type TokensQuery = { __typename?: 'Query', tokens: Array<{ __typename?: 'Token', id: string, updatedAt: string, createdAt: string, name: string, voteProposalUri: string, uri: string, nft: { __typename?: 'NFT', name: string, symbol: string, id: string } }> };
