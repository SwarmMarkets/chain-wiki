...
export function approvalForAllEvent(filters: ApprovalForAllEventFilters = {}) {
  return prepareEvent({
    signature: "event ApprovalForAll(address indexed owner, address indexed operator, bool isApproved)",
    filters,
  });
};
...
export type CommentRemovedEventFilters = Partial<{
  removedBy: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"removedBy","type":"address"}>
...
export function commentRemovedEvent(filters: CommentRemovedEventFilters = {}) {
  return prepareEvent({
    signature: "event CommentRemoved(address indexed removedBy, uint256 indexed tokenId, string comment, uint256 commentId)",
    filters,
  });
};
...
export type CommentedEventFilters = Partial<{
  commentator: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"commentator","type":"address"}>
tokenId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"tokenId","type":"uint256"}>
}>;
...
export function commentedEvent(filters: CommentedEventFilters = {}) {
  return prepareEvent({
    signature: "event Commented(address indexed commentator, uint256 indexed tokenId, string comment, uint256 commentId)",
    filters,
  });
};
...
export type ForceBurnEventFilters = Partial<{
  issuer: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"issuer","type":"address"}>
...
export function forceBurnEvent(filters: ForceBurnEventFilters = {}) {
  return prepareEvent({
    signature: "event ForceBurn(address indexed issuer, address indexed from, uint256 indexed tokenId, string reason)",
    filters,
  });
};
...
export function forceTransferEvent(filters: ForceTransferEventFilters = {}) {
  return prepareEvent({
    signature: "event ForceTransfer(address indexed issuer, address indexed from, address indexed to, uint256 tokenId)",
    filters,
  });
};
...
export type MintedEventFilters = Partial<{
  minter: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"minter","type":"address"}>
...
export function mintedEvent(filters: MintedEventFilters = {}) {
  return prepareEvent({
    signature: "event Minted(address indexed minter, address indexed receiver, uint256 tokenId, uint256 amount, string uri, string slug)",
    filters,
  });
};
...
export type RoleSetEventFilters = Partial<{
  holder: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"holder","type":"address"}>
role: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"role","type":"uint256"}>
active: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"bool","name":"active","type":"bool"}>
}>;
...
export function roleSetEvent(filters: RoleSetEventFilters = {}) {
  return prepareEvent({
    signature: "event RoleSet(address indexed holder, uint256 indexed role, bool indexed active)",
    filters,
  });
};
 ...
 * ```
 */
export function tokenKyaUpdatedEvent(filters: TokenKyaUpdatedEventFilters = {}) {
  return prepareEvent({
    signature: "event TokenKyaUpdated(address indexed from, uint256 indexed id, string kya)",
    filters,
  });
};
...
export type TokenSlugUpdatedEventFilters = Partial<{
  slugId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"slugId","type":"uint256"}>
}>;
 ...
 * ```
 */
export function tokenSlugUpdatedEvent(filters: TokenSlugUpdatedEventFilters = {}) {
  return prepareEvent({
 ...
 * ```
 */
export function tokenURIUpdatedEvent(filters: TokenURIUpdatedEventFilters = {}) {
  return prepareEvent({
    signature: "event TokenURIUpdated(address from, uint256 indexed id, string uri)",
    filters,
  });
};
...
export function transferBatchEvent(filters: TransferBatchEventFilters = {}) {
  return prepareEvent({
    signature: "event TransferBatch(address indexed operator, address indexed from, address indexed to, uint256[] ids, uint256[] amounts)",
    filters,
  });
};
...
export function transferSingleEvent(filters: TransferSingleEventFilters = {}) {
  return prepareEvent({
    signature: "event TransferSingle(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 amount)",
    filters,
  });
};
 ...
 * ```
 */
export async function EDITOR_ROLE(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
...
export type BalanceOfBatchParams = {
  owners: AbiParameterToPrimitiveType<{"internalType":"address[]","name":"owners","type":"address[]"}>
...
commentId: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"commentId","type":"uint256"}>
};
 ...
 * ```
 */
export async function contractSlug(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
 ...
 * ```
 */
export async function currentAttestationId(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
...
export type HasRoleParams = {
  holder: AbiParameterToPrimitiveType<{"internalType":"address","name":"holder","type":"address"}>
role: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"role","type":"uint256"}>
};
 ...
 * ```
 */
export async function maxArraySize(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
...
export type RoleHolderAtParams = {
  role: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"role","type":"uint256"}>
i: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"i","type":"uint256"}>
};
 ...
 * ```
 */
export async function selfImplementation(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
...
export type SlugToTokenIdParams = {
  slug: AbiParameterToPrimitiveType<{"internalType":"string","name":"slug","type":"string"}>
};
...
export type BurnParams = {
  tokenId: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"tokenId","type":"uint256"}>
quantity: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"quantity","type":"uint256"}>
};
...
tokenId: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"tokenId","type":"uint256"}>
quantity: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"quantity","type":"uint256"}>
reason: AbiParameterToPrimitiveType<{"internalType":"string","name":"reason","type":"string"}>
};
 ...
 * ```
 */
export function forceBurn(
  options: BaseTransactionOptions<ForceBurnParams>
) {
  return prepareContractCall({
    contract: options.contract,
    method: [
...
quantities: AbiParameterToPrimitiveType<{"internalType":"uint256[]","name":"quantities","type":"uint256[]"}>
reason: AbiParameterToPrimitiveType<{"internalType":"string","name":"reason","type":"string"}>
};
...
export function forceBurnBatch(
  ...
  []
    ...
    params: [options.accounts, options.tokenIds, options.quantities, options.reason]
  });
};
...
export type InitializeParams = {
  data: AbiParameterToPrimitiveType<{"components":[{"internalType":"string","name":"name","type":"string"},{"internalType":"string","name":"symbol","type":"string"},{"internalType":"string","name":"kya","type":"string"}],"internalType":"struct ERC1155Data","name":"_data","type":"tuple"}>
slug: AbiParameterToPrimitiveType<{"internalType":"string","name":"_slug","type":"string"}>
roles: AbiParameterToPrimitiveType<{"components":[{"internalType":"address","name":"owner","type":"address"},{"internalType":"address[]","name":"admins","type":"address[]"},{"internalType":"address[]","name":"editors","type":"address[]"}],"internalType":"struct Roles","name":"_roles","type":"tuple"}>
...
export type MintParams = {
  to: AbiParameterToPrimitiveType<{"internalType":"address","name":"to","type":"address"}>
quantity: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"quantity","type":"uint256"}>
tokenURI: AbiParameterToPrimitiveType<{"internalType":"string","name":"tokenURI","type":"string"}>
slug: AbiParameterToPrimitiveType<{"internalType":"string","name":"slug","type":"string"}>
};
...
export type MintBatchParams = {
  accounts: AbiParameterToPrimitiveType<{"internalType":"address[]","name":"accounts","type":"address[]"}>
quantities: AbiParameterToPrimitiveType<{"internalType":"uint256[]","name":"quantities","type":"uint256[]"}>
tokenURIs: AbiParameterToPrimitiveType<{"internalType":"string[]","name":"tokenURIs","type":"string[]"}>
slugs: AbiParameterToPrimitiveType<{"internalType":"string[]","name":"slugs","type":"string[]"}>
};
...
export function mintBatch(
  options: BaseTransactionOptions<MintBatchParams>
) {
  return prepareContractCall({
    contract: options.contract,
    method: [
  ...
  []
    ...
    params: [options.accounts, options.quantities, options.tokenURIs, options.slugs]
  });
};
...
export type SetApprovalForAllParams = {
  operator: AbiParameterToPrimitiveType<{"internalType":"address","name":"operator","type":"address"}>
isApproved: AbiParameterToPrimitiveType<{"internalType":"bool","name":"isApproved","type":"bool"}>
};
...
export type SetContractKyaParams = {
  Kya: AbiParameterToPrimitiveType<{"internalType":"string","name":"Kya","type":"string"}>
};
...
export type SetMaxArraySizeParams = {
  maxSize: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"maxSize","type":"uint256"}>
};
...
export type SetRoleParams = {
  holder: AbiParameterToPrimitiveType<{"internalType":"address","name":"holder","type":"address"}>
role: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"role","type":"uint256"}>
active: AbiParameterToPrimitiveType<{"internalType":"bool","name":"active","type":"bool"}>
};
...
export function setRole(
  options: BaseTransactionOptions<SetRoleParams>
) {
  return prepareContractCall({
    contract: options.contract,
    method: [
