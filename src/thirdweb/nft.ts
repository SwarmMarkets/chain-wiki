...
export type ChainWikiDeployedEventFilters = Partial<{
  chainWiki: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"chainWiki","type":"address"}>
}>;
 ...
 * ```
 */
export function chainWikiDeployedEvent(filters: ChainWikiDeployedEventFilters = {}) {
  return prepareEvent({
    signature: "event ChainWikiDeployed(address indexed chainWiki, string slug, (string name, string symbol, string kya) data, (address owner, address[] admins, address[] editors) roles)",
    filters,
  });
};
...
export type ChainWikiToSlugParams = {
  chainWiki: AbiParameterToPrimitiveType<{"internalType":"address","name":"chainWiki","type":"address"}>
};
...
export type DeployChainWikiParams = {
  data: AbiParameterToPrimitiveType<{"components":[{"internalType":"string","name":"name","type":"string"},{"internalType":"string","name":"symbol","type":"string"},{"internalType":"string","name":"kya","type":"string"}],"internalType":"struct ERC1155Data","name":"data","type":"tuple"}>
slug: AbiParameterToPrimitiveType<{"internalType":"string","name":"slug","type":"string"}>
roles: AbiParameterToPrimitiveType<{"components":[{"internalType":"address","name":"owner","type":"address"},{"internalType":"address[]","name":"admins","type":"address[]"},{"internalType":"address[]","name":"editors","type":"address[]"}],"internalType":"struct Roles","name":"roles","type":"tuple"}>
};
